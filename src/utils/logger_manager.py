...
class LoggerManager:
    ...
    def setup_logger(self):
        if self.logger is None:
            ...
            base_log_file = os.path.join(log_dir, 'monitoring_worker_log.txt')
            ...
            # Sufijo de fecha para archivos rotados (monitoring_worker_log.txt.2025-10-18)
            ...
            # Log inicial
            self.logger.info(f"Monitoring Worker Logger initialized. Log file: {base_log_file} (rotates daily at midnight)")
